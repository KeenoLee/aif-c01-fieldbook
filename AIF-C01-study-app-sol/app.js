...
const quizQuestions = [
  ...
  ["d1", "Which metric answers: Of the actual positive cases, how many did the model find?", ["Precision", "Recall", "Latency", "Accuracy only"], 1, "Recall measures coverage of actual positives."],
